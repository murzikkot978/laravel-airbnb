        ...
        <form method="post" action="{{ route('apartments.store') }}" enctype="multipart/form-data"
            ...
            <div class="bg-gray-300 p-8 rounded-lg shadow-lg w-full">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <input type="number" name="price" id="price" placeholder="Price" class="border-2 rounded p-3"
                           required>
                    <input type="file" name="photos[]" id="photos" class="border-2 rounded p-3" multiple required>
                </div>
            </div>
            ...
            <div class="bg-gray-300 p-8 rounded-lg shadow-lg w-full">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <input type="text" name="street" id="street" placeholder="Address" class="border-2 rounded p-3"
                           required>
                    <iframe
